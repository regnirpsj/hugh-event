======================================================
Hull University Graphics Helper (HUGH) Event Handling
======================================================

.. image:: https://travis-ci.org/regnirpsj/hugh-events.svg?branch=master
   :target: https://travis-ci.org/regnirpsj/hugh-events
.. image:: https://coveralls.io/repos/github/regnirpsj/hugh-events/badge.svg?branch=master
   :target: https://coveralls.io/github/regnirpsj/hugh-events?branch=master
...
``hugh-events`` is an (experimental) infrastructure project to support the various graphics modules at the `Department of Computer Science`_, `The University of Hull`_.
